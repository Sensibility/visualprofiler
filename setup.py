...
setup(
	...
	url='https://github.com/Sensibility/visualprofiler',  # Optional
	...
	install_requires=['setuptools', 'typing', 'pygame', 'squarify'],  # Optional
	...
	# data_files=[('/usr/lib/systemd/system', ['connmonitor.service'])],  # Optional
	...
	entry_points={  # Optional
		'console_scripts': [
			'visualprofiler=visualprofiler.__init__:main',
		],
	},
